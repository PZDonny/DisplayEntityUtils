...
public class BDETextDisplay extends BDEDisplay<TextDisplay>{
    ...
    BDETextDisplay(Map<String, Object> map, Matrix4f parentTransform) {
        ...
        Color color = DEUCommandUtils.getColorFromText((String) options.get("color"));
        textAlpha = DEUCommandUtils.getOpacityAsByte((float) ((double) options.get("alpha")));

        backgroundColor = DEUCommandUtils.getColorFromText((String) options.get("backgroundColor"))
