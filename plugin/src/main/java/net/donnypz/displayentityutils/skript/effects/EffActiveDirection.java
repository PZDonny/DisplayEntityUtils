...
public class EffActiveDirection extends Effect {
    static {
        Skript.registerEffect(EffActiveDirection.class,"[deu ](make|set) %activegroups/activeparts/multipartfilters%['s] (1¦yaw [p:with [interaction ]pivot]|2¦pitch) [to|as] %-number%");
    }
