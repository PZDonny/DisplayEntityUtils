...
public class EffActiveGlow extends Effect {
    static {
        Skript.registerEffect(EffActiveGlow.class,"[deu ](make|set) %activegroups/activeparts/multipartfilters% (1¦glow[ing] [t:for %-timespan%] [p:for %-players%]|2¦unglow[ing] [p:for %-players%])");
    }
