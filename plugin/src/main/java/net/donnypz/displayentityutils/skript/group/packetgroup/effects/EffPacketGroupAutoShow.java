...
@Name("Packet Group Autoshow/Visibility")
...
public class EffPacketGroupAutoShow extends Effect {
    ...
    public static void register(SyntaxRegistry registry){
        registry.register(SyntaxRegistry.EFFECT,
                SyntaxInfo.builder(EffPacketGroupAutoShow.class)
                        .addPattern("make %packetgroups% [:stop] autoshow[ing] [h:and hide from current [players|viewers]]")
                        .supplier(EffPacketGroupAutoShow::new)
                        .build()
        );
    }
