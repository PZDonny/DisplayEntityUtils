package net.donnypz.displayentityutils.skript.group.spawnedgroup.expressions;
...
@Description("Get the non-packet based groups riding an entity")
...
public class ExprEntitySpawnedGroupPassengers extends PropertyExpression<Entity,SpawnedDisplayEntityGroup> {
    ...
    public static void register(SyntaxRegistry registry){
        registry.register(SyntaxRegistry.EXPRESSION,
                SyntaxInfo.Expression.builder(ExprEntitySpawnedGroupPassengers.class, SpawnedDisplayEntityGroup.class)
                        .addPatterns(getPatterns("spawned[ |-]group passengers", "entities"))
                        .supplier(ExprEntitySpawnedGroupPassengers::new)
                        .build()
        );
    }
    ...
    protected SpawnedDisplayEntityGroup[] get(Event event, Entity[] objects) {
        return Arrays.stream(objects)
                ...
                .flatMap(entity -> DisplayUtils.getGroupPassengers(entity).stream())
                .toArray(SpawnedDisplayEntityGroup[]::new);
    }
