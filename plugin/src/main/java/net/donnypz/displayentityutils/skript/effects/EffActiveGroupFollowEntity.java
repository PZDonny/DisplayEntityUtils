...
@Examples({
        ...
        "make {_activegroup} respect {_entity} using pitch_and_yaw and after death despawn after 2 seconds",
        "",
        "#Combined",
        "make {_activegroup} respect {_entity} using yaw and flip group and with smoothness of 2 and despawn after 1 second"})
